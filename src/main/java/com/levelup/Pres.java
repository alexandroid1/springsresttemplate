...
public class Pres {
     ...
     */
    public Pres(List<Object> $OriginalValidate) {
        super();
    ...
    public Pres with$OriginalValidate(List<Object> $OriginalValidate) {
        this.$OriginalValidate = $OriginalValidate;
        return this;
    }
    ...
    public Pres withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pres) == false) {
            return false;
        }
        Pres rhs = ((Pres) other);
